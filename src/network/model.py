...
from network.layers import FullGatedConv2D
...
class NormalizedOptimizer(tf.keras.optimizers.Optimizer):
    ...
    def __init__(self, optimizer, name='normalized_optimizer', **kwargs):
        super().__init__(name=name, learning_rate=0.001, **kwargs)
    ...
    def apply_gradients(self, grads_and_vars, name='normalized_optimizer', skip_gradients_aggregation=False):
